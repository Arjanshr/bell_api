...
<body>
    <div class="invoice-box">
        ...
        <p style="margin-top:30px; color:green; font-weight:bold;">Your order has been completed. Thank you for choosing us!</p>
        <p style="margin-top:10px;">We would love to hear your feedback! Please take a moment to <a href="{{ $reviewLink }}">review our product</a>.</p>
        <p style="margin-top:10px;">Best regards,<br>Mobile Mandu Team</p>
    </div>
</body>
</html>
